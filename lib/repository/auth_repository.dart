...
class AuthRepository{
  ...
  Future<bool> loginOperation(username,pass)async{
    ...
    if(loginResponse!=null){
      var userInfo = await _loginServices.getUserOperation(/*loginResponse.content?.preferredUsername.toString()*/loginResponse.content?.preferredUsername.toString(),loginResponse.token);
