...
public class InstanceUploaderAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String submittedBy = cursor.getString(cursor.getColumnIndex(InstanceColumns.SUBMITTED_BY));

        viewHolder.formTitle.setText(cursor.getString(cursor.getColumnIndex(InstanceColumns.DISPLAY_NAME)));
        viewHolder.formSubtitle.setText(InstanceProvider.getDisplaySubtext(context, submittedBy, status, new Date(lastStatusChangeDate)));
