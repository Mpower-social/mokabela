...
public class SmsNotificationReceiver extends BroadcastReceiver {
    public static final String SMS_NOTIFICATION_ACTION = BuildConfig.APPLICATION_ID + ".COLLECT_SMS_NOTIFICATION_ACTION";
    private static final String SMS_NOTIFICATION_GROUP = BuildConfig.APPLICATION_ID + ".COLLECT_SMS_NOTIFICATION_GROUP";
