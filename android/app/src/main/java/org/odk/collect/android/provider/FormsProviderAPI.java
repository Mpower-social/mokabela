...
public final class FormsProviderAPI {
    ...
    public static final class FormsColumns implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd."+ BuildConfig.APPLICATION_ID + ".form";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + BuildConfig.APPLICATION_ID + ".form";
