...
public class InstanceProvider extends ContentProvider {
    ...
    public static String getDisplaySubtext(Context context, String submittedBy, String state, Date date) {
        if(submittedBy == null || submittedBy.isEmpty())
            submittedBy = Collect.getInstance().getUsername();
        ...
        try {
            if (state == null) {
                ...
                return new SimpleDateFormat(context.getString(R.string.saved_on_date_at_time,
                        submittedBy), Locale.getDefault()).format(date);
    ...
    static {
        ...
        sInstancesProjectionMap.put(InstanceColumns.MODULE_ID, InstanceColumns.MODULE_ID);
        sInstancesProjectionMap.put(InstanceColumns.SUB_MODULE_ID, InstanceColumns.SUB_MODULE_ID);
        sInstancesProjectionMap.put(InstanceColumns.INSTANCE_ID, InstanceColumns.INSTANCE_ID);
        sInstancesProjectionMap.put(InstanceColumns.SUBMITTED_BY, InstanceColumns.SUBMITTED_BY);
    }
}
