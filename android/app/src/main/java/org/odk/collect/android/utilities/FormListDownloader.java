...
public class FormListDownloader {
    ...
    public HashMap<String, FormDetails> downloadFormList(@Nullable String url, @Nullable String username,
        ...
        if (!downloadListUrl.endsWith(URL_PATH_SEP)) {
            downloadListUrl = downloadListUrl + URL_PATH_SEP;
        }
        ...
        if (!downloadPath.startsWith(URL_PATH_SEP)) {
            downloadPath = URL_PATH_SEP + downloadPath;
        }

        downloadListUrl += Collect.getInstance().getUsername() + downloadPath;
