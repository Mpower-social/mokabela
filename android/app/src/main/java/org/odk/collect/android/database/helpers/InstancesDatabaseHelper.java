...
import static org.odk.collect.android.provider.InstanceProviderAPI.InstanceColumns.INSTANCE_ID;
...
import static org.odk.collect.android.provider.InstanceProviderAPI.InstanceColumns.MODULE_ID;
...
import static org.odk.collect.android.provider.InstanceProviderAPI.InstanceColumns.SUBMITTED_BY;
import static org.odk.collect.android.provider.InstanceProviderAPI.InstanceColumns.SUB_MODULE_ID;
...
public class InstancesDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String[] COLUMN_NAMES_V7 = {_ID, DISPLAY_NAME, SUBMISSION_URI,
            CAN_EDIT_WHEN_COMPLETE, INSTANCE_FILE_PATH, JR_FORM_ID, JR_VERSION, STATUS,
            LAST_STATUS_CHANGE_DATE, DELETED_DATE, GEOMETRY, GEOMETRY_TYPE,
            MODULE_ID, SUB_MODULE_ID, INSTANCE_ID, SUBMITTED_BY};
    ...
    private void upgradeToVersion7(SQLiteDatabase db, String name) {
        SQLiteUtils.addColumn(db, name, MODULE_ID, "text");
        SQLiteUtils.addColumn(db, name, SUB_MODULE_ID, "text");
        SQLiteUtils.addColumn(db, name, INSTANCE_ID, "text");
        SQLiteUtils.addColumn(db, name, SUBMITTED_BY, "text");
    }
